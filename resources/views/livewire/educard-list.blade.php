<div class="flex flex-col justify-center items-center sm:p-3 w-full overflow-hidden"
    ...
    <div class="p-3 text-xl text-center">Descubre todas las educards. <span class="text-white">Escoge el tuyo.</span>
    </div>
            ...
            <div wire:click="redirectToMyRoute({{ $profesor->id }})"
                ...
                <div class="h-4/5 relative">
                    <div class="absolute inset-0 bg-cover bg-center">
                        <img src="{{ $profesor->imagen1 }}" alt="imagen1" class="w-auto h-full">
                    </div>
                    <div class="absolute w-1/5 h-5/6 right-0 px-2 text-xl text-white text-right flex flex-col-reverse">
                        @for ($i = 1; $i <= 4; $i++)
                    ...
                    <div
                        class="absolute w-full overflow-hidden h-1/6 bottom-0 px-2 text-base text-white flex items-start justify-center p-2 text-right bg-black bg-opacity-50">
