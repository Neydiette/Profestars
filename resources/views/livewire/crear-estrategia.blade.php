    ...
    <div class=" w-full flex flex-col justify-center items-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 grid-rows-2 gap-3 gap-x-10">
                ...
                <div class="row-span-4 overflow-hidden">
                    <x-ss-textarea-white label="Escribe tu estrategia:" classLabel="text-base sm:text-xl"
                        wire:model="estrategia" wire:input="$refresh">
                    </x-ss-textarea-white>
                </div>
                    ...
                    <div class="flex flex-wrap gap-5 items-center justify-center w-full">
                        <div class="block">
                            <label for="exito" class="flex items-center">
                                <input type="checkbox" id="exito" name="etiquetas[]" value="exito" wire:model="etiquetas">
                                <span class="ms-2 sm:text-sm text-xs text-gray-300">exito</span>
                            </label>
                        </div>
                        <div class="block">
                            <label for="salvasemestre" class="flex items-center">
                                <input type="checkbox" id="salvasemestre" name="etiquetas[]" value="salvasemestre" wire:model="etiquetas">
                                <span class="ms-2 sm:text-sm text-xs text-gray-300">salvasemestre</span>
                            </label>
                        </div>
                        <div class="block">
                            <label for="consejazo" class="flex items-center">
                                <input type="checkbox" id="consejazo" name="etiquetas[]" value="consejazo" wire:model="etiquetas">
                                <span class="ms-2 sm:text-sm text-xs text-gray-300">consejazo</span>
                            </label>
                        </div>
                        <div class="block">
                            <label for="experiencia" class="flex items-center">
                                <input type="checkbox" id="experiencia" name="etiquetas[]" value="experiencia" wire:model="etiquetas">
                                <span class="ms-2 sm:text-sm text-xs text-gray-300">experiencia</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex gap-5 p-5">
            <a href="{{ route('dashboard') }}"><x-ss-button class="w-full sm:text-lg text-sm text-center"
                    type="button">Regresar al menu</x-ss-button></a>
            <div><x-ss-button type="button" class="w-full sm:text-lg text-sm text-center" wire:click="submitForm" onclick="scrollToTop()">Enviar</x-ss-button></div>
        </div>
    </div>
    <script>
